...
public class company_name {
	...
	public Response getResponse (@PathParam("param") int  year){
		...
		base_network_cntrl base_net_cntrl_company = new  base_network_cntrl();
		
		//	Call the relevant method with requested year parameter 
		JsonNode json_baseNet1 = base_net_cntrl_company.get_base_network(year);
		
		//	Create a Response and return a JSON with status code 200 OK
		Response response = Response.ok(json_baseNet1, MediaType.APPLICATION_JSON).build();		
		return response;
