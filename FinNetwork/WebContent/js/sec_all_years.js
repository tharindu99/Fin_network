function sec_all_years(filename){
...
var color = d3.scaleOrdinal(d3.schemeCategory20);
    ...
    d3.json("data/"+filename+".json", function(error, graph) {
        ...
        links.forEach(function(link) {
            var s = link.source = nodeById.get(link.source),
                ...
                i = {}
                pred = link.role = role_filter(link.role),
  ...
  //add zoom capabilities
    ...
    function edge_click(d){
        new PNotify({
            title: 'Edge Details',
            text: 'Source: '+d[0].equity+'<br> Target: '+d[2].equity+'<br>Role: '+d[3]+'<br>ThreeSentences : '+d[4],
            type: 'success',
            styling: 'bootstrap3'
        });
    }
