...
d3.json("data/fin_network.json", function(error, graph) {
  ...
  var link = svg.append("g")
    ...
    .attr("stroke-width", 1)
        //-------create new div when mouse click -----------------------------------------------------------------------------------------------------------------
    .on('mouseover',edge_mouseover)  
    .on('click',sideDive)
    //-----------increase size of edge--------------------------------------------------------------------------------------------------------------------
...
/*var nodelabels = svg.selectAll(".nodelabel")
 ...
 function sideDive(d){
  ...
  //  $('#new1').text(d.target);
    $('#new2').text(d.THREE_SENTENCES);
     $('#new3').text(d.source.equity);
 }
 /* $('#new').slideReveal({
    trigger: $("#trigger")
  }); */
 /*   $('toggle').toggle(
   ...
   /* $('#slider').slideReveal({
    trigger: $("#trigger")
    console.log("trigeer paert check");
    }); */
   ...
   // div.style.float='top';
    ...
    div.textContent = d.ROLE;
    div.setAttribute('class', 'note');
    document.body.appendChild(div); */

     // console.log("check 11111111111111111111111111111");
     /* var para=document.createElement("p");
      var t=document.createTextNode("this is the paragraph");
      para.appendChild(t);
